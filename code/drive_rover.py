...
from perception import perception_step # perception.py included in the project repository
from decision import decision_step # we have to modify the function decision_step()
from supporting_functions import update_rover, create_output_images # not neccesary to modify
...
# usdate RoverState() object from within perception_step() function
class RoverState():
    def __init__(self):
        ...
        self.nav_angles = None # Angles of navigable terrain pixels # update this!
